...
$queryresult = mysqli_num_rows($query); 
    ...
    {   
        ...
        move_uploaded_file($file_tmp1,"../../student/achievement_activities/certificates/$pdffile1");
		// move_uploaded_file($file_tmp2,"../../professors/book-chapters/uploadsfrontit/$pdffile2");
        
 
            $query = "UPDATE achievement SET Name_Of_The_Student = '$Name_Of_The_Student', Roll_no = '$Roll_no', 
        Branch = '$Branch', Year_Of_Study = '$Year_Of_Study', Current_Year = '$Current_Year', 
        Extracurricular_Or_Cocurricular = '$Extracurricular_Or_Cocurricular', Name_Of_Activity = '$Name_Of_Activity', Others = '$Others', 
        Organizing_Body = '$Organizing_Body', Award_Or_Participation = '$Award_Or_Participation', Dates_From = '$Dates_From', Dates_To = '$Dates_To' WHERE id='$id'  ";
