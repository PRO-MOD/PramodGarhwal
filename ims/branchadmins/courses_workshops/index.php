...
<head>
    ...
    <title> Student Courses and Workshops </title>
...
<div id="tabledataid" class="card">
    <div class="card-body">
        ...
        <table id="datatableid" class="table table-bordered table-dark mt-2">
            ...
            $table_query = "SELECT * FROM courses WHERE Branch = '$branch' ORDER BY id ASC";
        ...
        if (isset($_POST['reject'])) {
            $id = $_POST['id'];
            $select = "UPDATE courses SET STATUS ='REJECTED' WHERE id='$id'";
            $result = mysqli_query($connection, $select);
            echo "Data Rejected";
            header("Location: index.php");
        }
...
<?php 
    if (isset($_POST["submit"])) {
        ...
        $sth = "SELECT * FROM `courses` WHERE branch = '$branch' AND (Name_Of_The_Student LIKE '%$str%' OR Roll_no LIKE '%$str%' OR Year_Of_Study LIKE '%$str%' OR Current_Year LIKE '%$str%' OR Type_Of_Course LIKE '%$str%' OR Title_Of_Course LIKE '$str' OR Organizing_Body LIKE '%$str%' OR Others LIKE '%$str%' OR Duration LIKE '%$str%' OR Dates_From LIKE '%$str%' OR Dates_To LIKE '%$str%' OR STATUS LIKE '$str')";
        ...
        $queryresult = mysqli_num_rows($result); ?>
                    ...
                    <div class="card">
                        <div class="card-body btn-group">
                        <div> Results- </div> &nbsp; &nbsp;
                        <button class="btn btn-success" onclick="exportTableToCSV('Search_Data_StudentCourses&Workshops.csv')"> Export Data </button>
                        </div>
                    </div>
