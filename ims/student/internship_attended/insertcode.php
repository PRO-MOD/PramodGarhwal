...
if (isset($_POST['insertdata'])) {
    ...
    (`Name_Of_The_Student`, `Roll_no`, `Branch`, `Year_Of_Study`,
     `Internship_Semester`, `Internship_Outcomes`, `Name_of_Organization`, `Number_of_Days_of_Internship`, 
     `Organizing_Addr`,`Dates_From`, `Dates_To`, `pdffile1`, `pdffile2`, `pdffile3`, `user_id`,`STATUS`) 
    VALUES ('$Name_Of_The_Student', '$Roll_no', '$branch', '$Year_Of_Study', '$Internship_Semester', 
    '$Internship_Outcomes','$Name_of_Organization', '$Number_of_Days_of_Internship', '$Organizing_Addr', '$Dates_From', '$Dates_To', '$pdffile1',  '$pdffile2',  '$pdffile3', '$id','PENDING')";
