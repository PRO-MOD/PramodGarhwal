...
foreach ($branches as $branchOption) {
    ...
    echo '<option value="' . $branchOption . '" ' . $selected . '>' . $branchOption . '</option>';
        ...
        ?>
                            ...
                            <div class="form-group">
                            <label>Year of Study (at the time of webinar/quiz/courses)</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="Type_Of_Course" class="form-control" placeholder="Enter Type" required>
                        </div>
...
foreach ($branches as $branchOption) {
    ...
    echo '<option value="' . $branchOption . '" ' . $selected . '>' . $branchOption . '</option>';
        ...
        ?>
                        ...
                        <div class="form-group">
                            <label> Type of Course </label>
                            <input type="text" id="Type_Of_Course" name="Type_Of_Course" class="form-control" required>
                        </div>
...
<?php 
    if (isset($_POST["submit"])) {
        ...
        $sth = "SELECT * FROM `courses` WHERE user_id='$id' AND (Branch LIKE '%$str%' OR Roll_no LIKE '%$str%' OR Name_Of_The_Student LIKE '%$str%' OR Year_Of_Study LIKE '%$str%' OR Current_Year LIKE '%$str%' OR Type_Of_Course LIKE '%$str%' OR Title_Of_Course LIKE '$str' OR Organizing_Body LIKE '%$str%' OR Others LIKE '%$str%' OR Duration LIKE '%$str%' OR Dates_From LIKE '%$str%' OR Dates_To LIKE '%$str%' OR STATUS LIKE '$str' ) ";
