...
$queryresult = mysqli_num_rows($query); 
    ...
    {   
        ...
        $query = "UPDATE courses SET Name_Of_The_Student = '$Name_Of_The_Student',Roll_no = '$Roll_no', Branch = '$Branch', 
        Year_Of_Study = '$Year_Of_Study', Current_Year = '$Current_Year', Type_Of_Course = '$Type_Of_Course', 
